  ...
  return (
    <div>
      ...
      <div className="flex">
        <div className="mt-3">
          ...
          <div className="grid grid-cols-2">
            <div className="font-medium text-l text-headingBlack">Name</div>
        ...
        <div className="mt-3 ml-[100px]">
          ...
          <div className="grid grid-cols-2">
            ...
            <div className="font-medium text-l text-headingBlack">: Female</div>
            <div className="font-medium text-l text-headingBlack">Sex</div>
            <div className="font-medium text-l text-headingBlack">: Female</div>
            <div className="font-medium text-l text-headingBlack">Pronouns</div>
            <div className="font-medium text-l text-headingBlack">
              : She/Her
            </div>
          </div>
          ...
          <div className="grid grid-cols-2">
            <div className="font-medium text-l text-headingBlack">Father</div>
            <div className="font-medium text-l text-headingBlack">
              : Mr. Hugh S. Chovey
            </div>
            <div className="font-medium text-l text-headingBlack">Mother</div>
            <div className="font-medium text-l text-headingBlack">
              : Mrs. Olive Chovey
            </div>
          </div>
      ...
      <div className="flex-1 mt-[40px]">
        <div className="font-bold text-4xl text-headingBlack">Education</div>
