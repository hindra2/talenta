...
export default function Home() {
  return (
    <main className="">
      <div className="flex flex-col items-end"><Image src="/talenta/topRightBGLogin.png" alt="school logo" width={400} height={400} />
      </div>
        ...
        <div className="mt-[-160px]">
          ...
          <div>
            <div className="flex h-[50px] w-[400px] bg-white shadow-lg rounded-2xl ml-[100px] mt-[20px]">
              <div className="ml-[5px] mt-[17px]"><Image src="/talenta/Mail.png" alt="school logo" width={28} height={10} /></div>
            ...
            <div className="flex h-[50px] w-[400px] mt-[15px] bg-white shadow-lg rounded-2xl ml-[100px]">
              <div className="ml-[9px] mt-[15px]"><Image src="/talenta/Lock.png" alt="school logo" width={22} height={5} /></div>
              <span className="ml-[8px] mt-[8px] font-bold text-xxxs text-headingBlack">PASSWORD</span>
              <div className="ml-[260px] mt-[15px]"><Image src="/talenta/Eye.png" alt="school logo" width={32} height={10} /></div>
            </div>
